...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Board Members</h6>
                    ...
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover responsive nowrap" style="width: 100%;"
                                ...
                                <tbody>
                                    <?php
                                    $listboard = mysqli_query($db, "SELECT *, CONCAT(tbl_boards.board_lastname, ', ', tbl_boards.board_firstname, ' ', tbl_boards.board_middlename) AS fullname FROM tbl_boards");
